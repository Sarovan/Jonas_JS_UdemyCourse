...
//     if (type === 'array') console.log(results);
//     else if (type === 'string')
...
//   options: ['0: JavaScript', '1: Python', '2: Rust', '3: C++'],
//   answers: new Array(4).fill(0),
//   displayResults(answers = this.answers, type = 'array') {
//     if (type === 'array') console.log(answers);
//     else if (type === 'string') {
...
//       ),
//     );
//     if (choice >= 0 && choice < this.answers.length) this.answers[choice] += 1;
//     this.displayResults(undefined, 'string');
//   },
// };
//
// document
